...
function configToProfileEntry(
  ...
  return {
    ...
    powerSwitchEntity: config.powerSwitchEntity,
    operationalStateEntity: config.operationalStateEntity,
    ...
    for (const entry of profile.entries) {
      ...
      try {
        await mappingStorage.setMapping({
          ...
          powerSwitchEntity: entry.powerSwitchEntity,
          operationalStateEntity: entry.operationalStateEntity,
